"""
DXF Geometry Extraction Service — FastAPI HTTP wrapper for Docker deployment.
...
app = FastAPI(title="DXF Geometry Extraction Service", version="1.0.0")
...
def health_check():
    ...
    return {"status": "healthy", "service": "dxf-geometry-extraction"}
