"""
Graph Export Service — FastAPI HTTP wrapper for Docker deployment.
...
app = FastAPI(title="Graph Export Service", version="1.0.0")
...
def health_check():
    ...
    return {"status": "healthy", "service": "graph-export"}
